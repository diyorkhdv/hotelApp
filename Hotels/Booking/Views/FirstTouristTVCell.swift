...
class FirstTouristTVCell: UITableViewCell {
    static let id = "FirstTouristTVCell"
    // MARK: - UI Elements
    ...
    let expandButton: UIButton = {
        ...
        button.setImage(UIImage(named: "expandUP"), for: .normal)
        return button
    }()
...
extension FirstTouristTVCell: UITextFieldDelegate {
